...
def create_db():
    ...
    # Creates tables
    cursor.execute("""CREATE TABLE user (user_id INT NOT NULL AUTO_INCREMENT, username VARCHAR(30) NOT NULL, password VARCHAR(30) NOT NULL, monthly_income FLOAT, 
                   monthly_expenses FLOAT, duration INT, monthly_wants FLOAT, monthly_savings FLOAT, total_wants FLOAT, total_savings FLOAT, PRIMARY KEY(user_id))""")
